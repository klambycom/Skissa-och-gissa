defmodule SkissaOchGissa.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule SkissaOchGissa.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :skissa_och_gissa,
                        pubsub_server: SkissaOchGissa.PubSub
end
